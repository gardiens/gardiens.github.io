...
export default function getSortedBlogsData() {

    const dirNames = fs.readdirSync(BlogsDirectory);

    const allBlogsData = dirNames.map(dirName => {
        const id = dirName;
        const fileName = `${id}.md`;

        const fullPath = path.join(BlogsDirectory, dirName, fileName);
